...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "apps.core.pagination.LegacyPagination",
    "PAGE_SIZE": 20,
    "EXCEPTION_HANDLER": "apps.core.exceptions.legacy_exception_handler",
}
SIMPLE_JWT = {
...
AWS_STORAGE_BUCKET_NAME = os.getenv("AWS_STORAGE_BUCKET_NAME", "myraid")
